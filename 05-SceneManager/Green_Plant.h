...
#define ID_ANI_GREEN_PLANT_LEFT_UNDER_NOT_SHOOT	321
#define ID_ANI_GREEN_PLANT_LEFT_UNDER_SHOOT 322
#define ID_ANI_GREEN_PLANT_LEFT_TOP_NOT_SHOOT 323
#define ID_ANI_GREEN_PLANT_LEFT_TOP_SHOOT 324
#define ID_ANI_GREEN_PLANT_RIGHT_UNDER_NOT_SHOOT 325
#define ID_ANI_GREEN_PLANT_RIGHT_UNDER_SHOOT 326
#define ID_ANI_GREEN_PLANT_RIGHT_TOP_NOT_SHOOT 327
#define ID_ANI_GREEN_PLANT_RIGHT_TOP_SHOOT 328


#define ID_ANI_GREEN_PLANT_NOT_SHOOT 311

#define DISTANCE_PIPE_LONG_SHORT 8

#define PLANT_TYPE_SHOOT 1
#define PLANT_TYPE_NOT_SHOOT 2



class CGreen_Plant : public CGameObject
{
protected:
	float loacationX;
	float startY;
...
public:
	CGreen_Plant(float x, float y, int type);
